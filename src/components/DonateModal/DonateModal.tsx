  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.textContent}>
        ...
        помимо времени - на инфрастуктуру проекта уходят деньги, а на проекте
        нет ни рекламы, ни каких-либо других способов монетизации. Поэтому эти
        пожертвования целиков пойдут на оплату инфрастуктуры, и возможно кофе.
      </div>
